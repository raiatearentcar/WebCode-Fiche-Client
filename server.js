...
const db = new sqlite3.Database(dbPath, (err) => {
  if (err) {
    ...
    // Création des tables avec ABSOLUMENT TOUS les champs du formulaire
    db.run(`CREATE TABLE IF NOT EXISTS clients (
      ...
      /* Traitement des données et signature */
...
app.post('/api/submit', async (req, res) => {
  try {
    ...
    try {
      ...
      // Insérer les données dans la base de données en arrière-plan
